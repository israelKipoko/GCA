...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-3 text-[12px] dark:bg-dark-secondary bg-light-thirdly dark:text-white text-dark-secondary", className)}
      classNames={{
        ...
        day_selected:
          "bg-[#356B8C] text-[#fff] hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground",
        day_today: "bg-[#f0f0f022] text-white ",
        day_outside:
