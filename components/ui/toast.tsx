...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-0 z-[100] flex max-h-screen w-full flex-col-reverse p-1.5 sm:bottom-0 sm:right-0 sm:top-auto sm:flex-col md:max-w-[350px]",
      className
    )}
    {...props}
  />
