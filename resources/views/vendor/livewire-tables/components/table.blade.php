...
@if ($component->isTailwind())
    <div
        ...
        {{ $attributes->merge($customAttributes['wrapper'])
            ->class(['shadow overflow-y-auto border border-[#356B8C] dark:border-[#356B8C] sm:rounded-lg' => $customAttributes['wrapper']['default'] ?? true])
            ->except('default') }}
   style="box-shadow: rgba(255, 255, 255, 0.16) 0px 1px 4px;" >
        <table
