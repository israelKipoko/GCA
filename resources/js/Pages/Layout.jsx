...
return (
    <section className='w-full ' >
        <SidebarProvider defaultOpen="true"  className='w-full '>
            <SideBar refreshLayout={refreshLayout} allUsers={allUsers}/> 
            ...
            <section className=' flex flex-col float-right  px-3 gap-y-9 w-full '>
                <section className="pt-9 ">
                    <div>
                        <h1 className="dark:text-white text-dark-secondary font-bold md:text-[24px] text-[20px] capitalize text-center">{greeting}, {user.firstname} {user.name}</h1>
                    </div>
                </section>
            <div>
